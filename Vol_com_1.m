...
plot(x,yp_io_p2,'b--')
hold on
[x,yp_po_p2] = PullDVH("C:\Users\SA\Desktop\0531\Thesis\Data\histogram_DVH_pre and Intra op plans\P2_PostOp - Default - DVH Data.txt");
plot(x,yp_po_p2,'g--')

% % OAR 1
% [x,yr2] = PullDVH("C:\Users\SA\Desktop\0531\Thesis\Data\histogram_DVH_pre and Intra op plans\P2_Rectum Intra-OP - Preplan - DVH Data.txt");
% plot(x,yr2,'g--')
% 
% [x,yr_io2] = PullDVH("C:\Users\SA\Desktop\0531\Thesis\Data\histogram_DVH_pre and Intra op plans\P2_Rectum Intra-OP - Intraop - DVH Data.txt");
% plot(x,yr_io2,'g')
% 
% % OAR 2
% [x,yu2] = PullDVH("C:\Users\SA\Desktop\0531\Thesis\Data\histogram_DVH_pre and Intra op plans\P2_Urethra Intra-OP - Preplan - DVH Data.txt");
% plot(x,yu2,'b--')
% 
% [x,yu_io2] = PullDVH("C:\Users\SA\Desktop\0531\Thesis\Data\histogram_DVH_pre and Intra op plans\P2_Urethra Intra-OP - Intraop - DVH Data.txt");
% plot(x,yu_io2,'b')
% 
% legend("Plan Target","IntraOp Target","Plan Rectum","IntraOp Rectum","Plan Urethra","IntraOp Urethra")
xlabel('Dose (Gy)')
...
dosePre = squeeze(dicomread('C:\Users\SA\Desktop\0531\Thesis\Data\Pat1_Preplan\DO001.dcm'));
dosePost = squeeze(dicomread('C:\Users\SA\Desktop\0531\Thesis\Data\Pat1_IntraoperativeTrementPlan\DO001.dcm'));
...
for i=1:4
    x = [x;quadStats2{i,2},quadStats2{i,3}];
end
figure
bar(x)
set(gca,'xticklabel',{'p11','p12','p13','p14','p21','p22','p23','p24'})
legend('mean','std')
%% inner problem 
...
dosePre = squeeze(dicomread('C:\Users\SA\Desktop\0531\Thesis\Data\Pat2_Preplan\DO001.dcm'));
dosePost = squeeze(dicomread('C:\Users\SA\Desktop\0531\Thesis\Data\Pat2_IntraoperativeTrementPlan\DO001.dcm'));
dosePpost = squeeze(dicomread('C:\Users\SA\Desktop\0531\Thesis\Data\Pat2_PostOpplan\DO001.dcm'));
dosePre = sum(dosePre,3)/10;
dosePost = sum(dosePost,3)/10;
dosePpost = sum(dosePpost,3)/10;
...
dosemap3 = sum(dosePpost,3);
ma = max(dosemap3,[],'all');
mi = min(dosemap3,[],'all');
dosemap_16 = uint16((dosemap3-mi)/(ma-mi)*65536);
...
testmap3 = zeros(80,80);
for i = 1:80
    testmap3(i,spot{i}) = testmap3(i,spot{i}) + 1;
end 
for i = 1:80
    testmap3(spot_v{i},i) = testmap3(spot_v{i},i) + 1;
end 
...
line([1,80],[40,40]);hold on; line([40,40],[1,80]);
% legend({'pre','pre_r','pre_u','post','post_r','post_u'},'Location','eastoutside')
legend({'pre','intro','post'},'Location','eastoutside')
title(['D90 V100 P2'])
